...
const Dict kTr = {
  ...
  {"update_asset_missing", "Bu release icinde .exe dosyasi bulunamadi."},
...
const Dict kEn = {
  ...
  {"update_asset_missing", "No .exe asset found in this release."},
...
const Dict kDe = {
  ...
  {"update_asset_missing", "In diesem Release wurde keine .exe-Datei gefunden."},
...
const Dict kFr = {
  ...
  {"update_asset_missing", "Aucun fichier .exe n'a ete trouve dans cette release."},
...
const Dict kEs = {
  ...
  {"update_asset_missing", "No se encontro ningun archivo .exe en esta release."},
